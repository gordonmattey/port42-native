...
public struct EditSpaceSheet: View {
    ...
    public init(space: Binding<Space?>) {
        self._space = space
    }

    public var body: some View {
        guard let ch = space else { return AnyView(EmptyView()) }
    ...
    private func save() {
        guard var ch = space, canSave else { return }
