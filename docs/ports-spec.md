...
| P-261 | Permission Attribution | The permission dialog currently says "This port wants to access your terminal." It should say which companion is asking. **Fix applied (2026-03-20):** `PortPermissionOverlay` now accepts `createdBy: String?` and shows the companion name in accent color above the permission title. | High | ✅ Fixed |
